...
export default function Home() {
  return (
    <div className="relative h-screen">
      ...
      <div className="absolute top-0 right-0 m-4 text-white text-right">
      ...
      <div className="absolute top-36 right-0 m-4 text-white text-right">
        <div className="my-10 flex flex-col items-center">
          <Link href={'/become'}>
            <img
      ...
      <div className="absolute top-60 right-0 m-4 text-white text-right">
        <div className="my-10 flex flex-col items-center">
          <Link href={'/shop'}>
            <img
