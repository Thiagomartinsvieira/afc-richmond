    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative w-full h-96">
        <Image
          ...
          src="/images/stadium/stadium_entrance.jpg"
      ...
      <div className="container mx-auto mt-8 mb-12">
        ...
        <p className="text-lg leading-relaxed text-center">
          ...
          supporters, its very important to the community.
        </p>
      </div>
      <div className="container mx-auto mb-12">
        ...
        <p className="text-lg leading-relaxed text-center">
          ...
          wasnt for a football tryout, but there were recruiters waiting to
          ...
          didnt come home from the war, and ever since then, the players always
